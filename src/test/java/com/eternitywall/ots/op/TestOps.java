...
public class TestOps {
    ...
    public void testKeccak() {
        ...
        assertEquals("c5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470",
                     Utils.bytesToHex(result).toLowerCase());

        byte[] result2 = new OpKECCAK256().call(Utils.hexToBytes("80"));
        assertEquals("56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421",
                     Utils.bytesToHex(result2).toLowerCase());
    }

    @Test
    public void testSha1() {
        byte[] result = new OpSHA1().call(Utils.hexToBytes("0a"));
        assertEquals("adc83b19e793491b1c6ea0fd8b46cd9f32e592fc",
                     Utils.bytesToHex(result).toLowerCase());
    }
    ...
    public void testAppend() {
        byte[] zeroes = Utils.hexToBytes("00");
        byte[] ones = Utils.hexToBytes("11");
        byte[] call = new OpAppend(zeroes).call(ones);
    ...
    public void testPrepend() {
        byte[] zeroes = Utils.hexToBytes("00");
        byte[] ones = Utils.hexToBytes("11");
        byte[] call = new OpPrepend(zeroes).call(ones);
